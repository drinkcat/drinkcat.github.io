---
layout: post
title: "Olympus OM 50mm f/1.8 on Micro Four Thirds"
date: 2013-07-22 19:00:00+08:00
categories: photo blogspot
---

One of the strong points of the Micro Four Thirds (MFT) system is that, thanks to its short [flange focal distance](http://en.wikipedia.org/wiki/Flange_focal_distance), you can mount lenses designed for almost any other camera system.
...
I used that lens for a number of night shots, and realised that the [bokeh](http://en.wikipedia.org/wiki/Bokeh) is not exactly as round and nice as it should be: there is some "dirt" on the left side of the disk (when held in landscape orientation). This does not show up clearly in most shots, but it looks quite silly when the same pattern repeats in different locations on the frame:

{% include img.html src="/images/olympus-om-50mm-f18-on-mft/P1150710.JPG" alt="Each of the bokeh rings shows some black spots at the bottom: looking through the lens, I can see some oil marks." %}

The [next post](/blog/2013/07/25/bokeh-fixing-opening-and-cleaning/) will show you how I managed to fix the problem, by opening up the lens.
