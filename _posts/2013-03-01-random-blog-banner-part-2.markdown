...
<!-- TODO: update random-blog-banner-part-1 link once 2013-02-random-blog-banner-part-1 is migrated -->
Alright, the [previous part](http://drinkcat.blogspot.com/2013/02/random-blog-banner-part-1.html) shows you the script that allows to randomly display a banner image. Now, this would quickly end up being a bit messy to manage, if you want to add a new banner, then update the page with the [list of all panoramas](../../p/panoramas.html).
