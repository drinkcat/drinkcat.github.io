---
layout: post
title: "Bokeh-fixing: Opening and cleaning an Olympus OM 50mm f/1.8"
date: 2013-07-25 19:00:00+08:00
categories: photo blogspot
---

In the [previous post](/blog/2013/07/22/olympus-om-50mm-f18-on-mft/), I talked about the Olympus OM 50mm f/1.8, and how I find it interesting to use on my Micro Four Thirds camera (Panasonic DMC-GX1), along with some sample shots.

When taking some night shots, with an object close in focus, I could see obvious defects in the [bokeh](http://en.wikipedia.org/wiki/Bokeh), that is, the round circle of light coming from a distant, out-of-focus, light.
...
{% include img.html src="/images/bokeh-fixing-opening-and-cleaning/P1200733a.JPG" alt="Spot light is about 200m away, focus set at 0.45m, aperture f/1.8. ISO 1600, 1/40s. The bokeh dimension is about 1000x1000 pixels, that is a little more than a fifth of the width of the image." %}
...
I looked up online, and [some people on dpreview forums](http://www.dpreview.com/forums/thread/2643603) advise that it may not be worth the fuss trying to open it up, and it would be easier to buy a new one, considered the price. On the other hand, it is such a cheap lens (~25USD with shipping) that it would not be a disaster if I broke it. Looking further, I found some diagrams on [Olympus Dementia](http://olympus.dementix.org/Hardware/), but even if you can figure out which exact model of lens you have (Olympus made multiple fairly different versions over the years), it still does not tell you how to open it.
...
{% include img.html src="/images/bokeh-fixing-opening-and-cleaning/P1200736a.JPG" alt="Back of the lens with 3 screws" %}
...
{% include img.html src="/images/bokeh-fixing-opening-and-cleaning/P1200740a.JPG" alt="Lens mount removed, showing the unlock lever" %}
...
{% include img.html src="/images/bokeh-fixing-opening-and-cleaning/P1200741a.JPG" alt="Aperture mechanism removed" %}
...
{% include img.html src="/images/bokeh-fixing-opening-and-cleaning/P1200743a.JPG" alt="Glue scraped from the metal ring joint" %}
...
{% include img.html src="/images/bokeh-fixing-opening-and-cleaning/P1200744a.JPG" alt="Metal ring removed, exposing the rear lens element" %}
