---
layout: post
title: "Pinwide \"lens\" - or real life Instagram"
date: 2013-01-29 20:00:00+08:00
categories: photo blogspot
---

I recently bought the [pinwide](http://wanderlustcameras.com/products/pinwide.html) cap for my micro 4/3 camera (Panasonic DMC-GX1). Sure, you can also make a pinhole by making a hole in a camera cap, but this one is "optimised", with the pinhole receding inside the camera body to get an image as wide as possible.

The adapter is made of good quality plastic (polycarbonate "[char siew](http://en.wikipedia.org/wiki/Char_siu)" according to [DigitalRevTV](http://www.youtube.com/watch?v=RLgM0Pac6qA&list=PL98C6084687FC7A94&index=42)), and comes in a nice little metal box.

{% include img.html src="/images/pinwide-lens-or-real-life-instragram/P1150737_modified.JPG" alt="Pinwide in its box" %}
...
{% include img.html src="/images/pinwide-lens-or-real-life-instragram/P1150741_corr_modified.JPG" alt="Pinhole and its membrane." %}
...
{% include img.html src="/images/pinwide-lens-or-real-life-instragram/P1150728.JPG" alt="ISO 1600, 1/50 exposure." %}

{% include img.html src="/images/pinwide-lens-or-real-life-instragram/P1150731.JPG" alt="ISO 1600, 1/60s. The sun flares in an interesting manner." %}
...
{% include img.html src="/images/pinwide-lens-or-real-life-instragram/P1150728_modified.JPG" alt="100% crop near the center of the image." %}
