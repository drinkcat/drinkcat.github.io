---
layout: post
title: "Dell Charger vs \"Dell\" Charger"
date: 2012-12-21 21:06:00+08:00
...
My 3-year old Dell charger had cable issues for a while now. The inner wires of the cable that goes from the charger to the laptop are exposed. The cable from the mains to the charger also broke once, but that part is [easy and cheap to replace](http://tweaklaptops.com/dell-power-cord/).

{% include img.html src="/images/dell-charger-vs-dell-charger/dell-charger-broken.JPG" alt="Exposed wires on the charger." %}
...
{% include img.html src="/images/dell-charger-vs-dell-charger/dell-logo-comparison.JPG" alt="Left: original charger. Right: eBay charger." %}

But when you carefully look at the logo, it becomes clear:

{% include img.html src="/images/dell-charger-vs-dell-charger/dell-logo-closeup.JPG" alt="Top: Original logo. Bottom: eBay charger logo." %}
...
Well, I wonder what I was expecting for 11$, but, if it says "Dell", I expect it to be a genuine charger! That is, I wouldn't have bought a "random-Chinese-company-name" charger. And now I end up with a counterfeit one...
